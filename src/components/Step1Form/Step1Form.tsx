                ...
                <div className={styles.personalInfoDiv}>
                    <div className={styles.formControll}>
                        <div className={styles.formInput}>
                            <input type="text" name="nameStep1" id="nameStep1"
                                   required  readOnly={true} placeholder={"Name"}
                                   className={styles.formInput}/>
                            <label className={styles.upLabel} htmlFor="nameStep1">Name</label>
                        </div>
                    </div>
                    <div className={styles.formControll}>
                        <div className={styles.formInput}>
                            <input readOnly={true} type="text" name="lastNameStep1"
                                   ...
                                   className={styles.formInput}/>
                            <label className={styles.upLabel} htmlFor="lastNameStep1">Last
                                name</label>
                        </div>
                    </div>
                    <div className={styles.formControll}>
