...
const Step2Form: React.FC<Step2FormProps> = ({ state, handleChangeVoen, goToPreviousStep, handleSubmitStep2}) => {
    return (
        <div className={styles.step2Container}>
            <div className={styles.formControll}>
                <div className={styles.formInput}>
                    <input type="text" name="voen" id="voen" required value={state.voen} onChange={handleChangeVoen}
    ...
    <div className={`${styles.formSubmit} ${styles.grid2}`}>
        <button type="button" className={styles.formBtn} onClick={goToPreviousStep}>Previous</button>
        <button type="button" className={styles.formBtn} onClick={handleSubmitStep2}>Next</button>
    </div>
</div>
)
    ;
